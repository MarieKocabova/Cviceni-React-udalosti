...
const Uloha3 = () => {
  const handleOnclick = (obdobi) => {
    console.log(`Uživatel zvolil ${obdobi}`);
  };
  ...
  return (
    <>
      ...
      <ol>
        <li>
					{/* dám sem anonimní funkci, jejíž výsledek je jaro - ten se pak předá té funkci nahoře */}
          <button onClick={() => handleOnclick("jaro.")}>
            <img src={kvetinaUrl} width={16} height={16} alt="květina" />
            jaro (březen až květen)
          </button>
        </li>
        <li>
          <button onClick={() => handleOnclick("léto.")}>
            <img src={slunceUrl} width={16} height={16} alt="slunce" />
            léto (červen až srpen)
          </button>
        </li>
        <li>
          <button onClick={() => handleOnclick("podzim.")}>
            <img src={listUrl} width={16} height={16} alt="list" />
            podzim (září až listopad)
          </button>
        </li>
        <li>
          <button onClick={() => handleOnclick("zimu.")}>
